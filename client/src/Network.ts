...
export default class Network {
    ...
    constructor(links: Link[]) {
        ...
        links.forEach((value, i) => {
            ...
            this._coords[coordLinkIndex] = value.fromCoordinate.x
            this._coords[coordLinkIndex + 1] = value.fromCoordinate.y
            this._coords[coordLinkIndex + 2] = 0
            this._coords[coordLinkIndex + 3] = value.toCoordinate.x
            this._coords[coordLinkIndex + 4] = value.toCoordinate.y
